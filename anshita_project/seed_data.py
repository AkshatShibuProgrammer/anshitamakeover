...
makeup_pkgs = [
    {
        'name': 'Imperial Royal Bridal Suite',
        'package_type': 'bridal',
        'tagline': 'Timeless Royalty for the Main Wedding & Pheras',
        'price': 35000.0,
        'price_label': '₹35,000',
        'features': "Airbrush / HD Micro-Pigment Bridal Base\nLuxury International Kit (Dior, Huda, MAC, Charlotte Tilbury)\nPre-Bridal Dermal & Skin Hydration Prep\nHaute Couture Hair Sculpting & Floral Placement\nRoyal Saree / Lehenga Draping & Dupatta Pinning\nJewellery Accentuation & Swarovski Setting\nComplimentary Luxury Touch-up Kit",
        'is_featured': True,
        'order': 1,
    },
    {
        'name': 'Side Makeup & Bridesmaid Suite',
        'package_type': 'side_makeup',
        'tagline': 'Elegance for Mothers, Sisters & Bridesmaids',
        'price': 6500.0,
        'price_label': '₹6,500 / person',
        'features': "Premium HD Long-Wear Base\nSubtle Sculpting & Luminescent Highlights\nEvent-Ready Eye Artistry & Lashes\nCouture Hair Styling (Buns, Braids, Textured Waves)\nDupatta Setting & Saree Draping\nGroup Privilege: ₹16,500 for Trio (3 Persons)\nSeamless Coordination with Bride's Aesthetic",
        'is_featured': True,
        'order': 2,
    },
    {
        'name': 'Engagement & Roka Luminescence',
        'package_type': 'engagement',
        'tagline': 'Romantic Dewy Glow & Modern Glamour',
        'price': 18000.0,
        'price_label': '₹18,000',
        'features': "HD Dewy Glass Skin or Velveteen Base\nSoft Romantic Glam Eye Makeup\nContouring, Tinted Blush & Shimmer Highlighting\nContemporary Hollywood Waves or Half-Updo\nGown / Lehenga Draping & Styling\nLash Extensions & Lip Art",
        'is_featured': False,
        'order': 3,
    },
    {
        'name': 'Reception & Sangeet Statement Glam',
        'package_type': 'reception',
        'tagline': 'High-Impact Red Carpet Glamour for Evening',
        'price': 22000.0,
        'price_label': '₹22,000',
        'features': "Smokey Kohl / Metallic Evening Eye Art\nSweatproof High-Definition Base for Stage & Dance\nSharp Sculpted Contouring & Radiant Finish\nVoluminous Textured Hair Couture\nSaree / Gown / Indo-Western Draping\nPremium Mink Lashes",
        'is_featured': False,
        'order': 4,
    },
    {
        'name': 'Party & Auspicious Occasion Glam',
        'package_type': 'party',
        'tagline': 'Fresh, Effortless & Sophisticated Party Look',
        'price': 4500.0,
        'price_label': '₹4,500',
        'features': "Flawless HD Party Base Application\nDay or Evening Eye Accentuation\nNatural Contouring & Dewy Glow\nQuick Chic Hair Styling & Ironing / Curls\nOutfit Styling & Dupatta Setting",
        'is_featured': False,
        'order': 5,
    },
    {
        'name': 'Pre-Bridal Dermal & Skin Therapy',
        'package_type': 'beauty',
        'tagline': 'Radiance Rituals & Intensive Bridal Glow Prep',
        'price': 8000.0,
        'price_label': '₹8,000',
        'features': "Hydra-Infusion Deep Cleansing Facial\nSkin Exfoliation & Dermal Rejuvenation\nTan Removal & Gold Brightening Therapy\nUnder-Eye Recovery & Lip Hydration Treatment\nPersonalized Skin Care Consultation",
        'is_featured': False,
        'order': 6,
    },
]
